...
public:
   ...
   */
  STDPSinCommonProperties(): CommonSynapseProperties(),
    A_plus_( 1.0 ),
    A_minus_( 1.0 ),
    Wmin_( 0.0 ),
    Wmax_( 200.0 )
...
/**
 * Class representing an STDPSinConnectionHom with homogeneous parameters,
 * i.e. parameters are the same for all synapses.
 */
template < typename targetidentifierT >
class STDPSinConnectionHom : public nest::Connection< targetidentifierT >
{
...
public:
   ...
   */
  STDPSinConnectionHom( const STDPSinConnectionHom& );
